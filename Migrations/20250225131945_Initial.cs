        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasBeenReturned = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowedBooks_AspNetUsers_BorrowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BorrowedBookId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReturnerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnedBooks_AspNetUsers_ReturnerId",
                        column: x => x.ReturnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnedBooks_BorrowedBooks_BorrowedBookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnedBooks_BorrowedBookId",
                table: "ReturnedBooks",
                column: "BorrowedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnedBooks_ReturnerId",
                table: "ReturnedBooks",
                column: "ReturnerId");
        }
