...
namespace LibraryManagementSystem.Migrations
{
    ...
    [Migration("20250225131945_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.ReturnedBook", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BorrowedBookId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.ReturnedBook", b =>
                {
                    b.HasOne("LibraryManagementSystem.Models.BorrowedBook", "BorrowedBook")
                        .WithMany("ReturnedBooks")
                        .HasForeignKey("BorrowedBookId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Returner")
                        .WithMany()
